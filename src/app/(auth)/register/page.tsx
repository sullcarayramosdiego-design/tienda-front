  ...
  const onSubmit = async (data: RegisterFormData) => {
    try {
      ...
      toast({
        ...
        description: "Bienvenido a la plataforma 3D. Iniciando redirección...",
        type: "success"
      });
        ...
        <CardHeader className="space-y-1 pb-4">
          <div className="flex flex-col items-center space-y-2 mb-2">
            ...
            <CardDescription className="text-center text-xs sm:text-sm">
              Únete a la nueva experiencia de E-Commerce en 3D
            </CardDescription>
          </div>
        </CardHeader>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-xs font-semibold text-foreground/80">Nombre completo</FormLabel>
                    <FormControl>
                      <div className="relative group">
                        <User className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground transition-colors duration-200 group-focus-within:text-primary" />
                        <Input
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-xs font-semibold text-foreground/80">Confirmar contraseña</FormLabel>
                    <FormControl>
                      <div className="relative group">
                        <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground transition-colors duration-200 group-focus-within:text-primary" />
                        <Input
