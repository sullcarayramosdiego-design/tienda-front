...
export default function ProductPage({
  ...
  const productId = resolvedParams.slug; // Params.slug represents the product ID in this Next.js dynamic routing path
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 p-4 border border-primary/10 bg-card/60 backdrop-blur-md rounded-2xl">
              ...
              <div className="flex items-center gap-2 flex-wrap">
                <span className="text-[10px] font-black uppercase text-muted-foreground mr-1 flex items-center gap-1">
                  <Wallet className="h-3.5 w-3.5 text-primary" /> Pagos Locales:
                </span>
                <span className="px-2.5 py-1 text-[9px] font-extrabold rounded-md bg-gradient-to-r from-[#00D47C]/15 to-[#00D47C]/5 text-[#00AF66] border border-[#00D47C]/20 shadow-sm uppercase tracking-wider select-none">
                  Yape
                </span>
                <span className="px-2.5 py-1 text-[9px] font-extrabold rounded-md bg-gradient-to-r from-[#00D2D3]/15 to-[#00D2D3]/5 text-[#00A8A9] border border-[#00D2D3]/20 shadow-sm uppercase tracking-wider select-none">
                  Plin
                </span>
                <span className="px-2.5 py-1 text-[9px] font-extrabold rounded-md bg-gradient-to-r from-[#FF5E00]/15 to-[#FF5E00]/5 text-[#E05300] border border-[#FF5E00]/20 shadow-sm uppercase tracking-wider select-none">
                  PagoEfectivo
                </span>
              </div>
            </div>
