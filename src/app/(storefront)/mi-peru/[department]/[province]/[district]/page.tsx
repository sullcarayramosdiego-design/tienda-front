...
function FestivityCard({ festivity, accentColor = 'primary' }: FestivityCardProps) {
  const colorMap = {
  ...
  return (
    <div className={cn('rounded-xl border p-4 transition-all duration-200', colorMap[accentColor])}>
