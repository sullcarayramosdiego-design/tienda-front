...
import { Gift, Copy, Check, Users, Award, HelpCircle, Share2, AlertCircle } from 'lucide-react';
...
export default function StandaloneReferralsPage() {
  const { user } = useAuth();
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-background via-background to-secondary/5 pb-20 w-full">
        <main className="w-full px-4 sm:px-6 lg:px-8 pt-6 space-y-6 animate-pulse">
  ...
  return (
    <div className="w-full py-6">
      <div className="bg-card/40 border border-primary/10 rounded-3xl p-6 sm:p-8 shadow-xl backdrop-blur-md w-full space-y-6">
