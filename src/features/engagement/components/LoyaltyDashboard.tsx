...
import type { LoyaltyTier, PointsTransaction } from '@/features/engagement';
      ...
      <section className="space-y-4">
        ...
        <Card className="border-destructive/30 bg-destructive/5">
          <CardContent className="p-5 flex items-center gap-3">
            ...
            <Button variant="outline" size="sm" onClick={fetchAccount} className="ml-auto text-xs cursor-pointer">
              Reintentar
            </Button>
          </CardContent>
        </Card>
  ...
  return (
    <section className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button variant="ghost" size="sm" onClick={fetchAccount} className="text-xs gap-1.5 cursor-pointer">
          ...
          <Card className="border-primary/10 bg-card/60 backdrop-blur-sm">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center gap-2">
                <Button
                  variant="outline" size="icon" className="h-9 w-9 shrink-0 cursor-pointer"
            ...
            <CardContent>
              {account.transactions.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <Button variant="ghost" size="sm" className="mt-3 gap-1.5 text-primary cursor-pointer" asChild>
                    <a href="/catalog">
